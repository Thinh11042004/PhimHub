...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleAvatarUpdate = () => {
      // Không cần gọi refreshUser vì uploadAvatar đã cập nhật state
      // Chỉ cần dispatch event để các component khác biết avatar đã thay đổi
                  ...
                  {user.role === 'admin' ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <span className="font-medium">Quản lý phim lẻ</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="font-medium">Quản lý phim bộ</span>
                      </button>
                    </>
                  ) : (
                    // User Menu
