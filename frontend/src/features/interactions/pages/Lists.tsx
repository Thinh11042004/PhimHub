...
function Card({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 ring-1 ring-white/10 hover:ring-white/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20 w-36">
      {/* Remove button */}
      <button
        onClick={onRemove}
...
function ListCard({
  ...
  return (
    <div className="group relative flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 ring-1 ring-white/10 hover:ring-white/20 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
      {/* Remove button */}
      <button
        onClick={onRemove}
...
export default function Lists() {
  ...
  const clearShown = async () => {
    if (!active || !viewItems.length) return;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px,1fr] gap-8">
          ...
          <aside className="space-y-4">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/10">
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-lg font-semibold text-white">Danh sách của tôi</h2>
                <button 
                  onClick={createList} 
                  className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200"
                >
                  + Tạo mới
                </button>
              </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="rounded-lg bg-white/10 px-3 py-1.5 text-xs text-white/80 hover:bg-white/20 hover:text-white transition-colors"
                        title="Đổi tên"
                      >
                        Sửa
                      </button>
                      <button
                        ...
                        className="rounded-lg bg-red-500/20 px-3 py-1.5 text-xs text-red-400 hover:bg-red-500/30 hover:text-red-300 transition-colors"
                        title="Xóa danh sách"
                      >
                        Xóa
                      </button>
          ...
          <section>
            {/* Toolbar */}
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/10 mb-6">
                ...
                <div className="flex-1">
                  ...
                  {activeList && (
                    <div className="flex items-center gap-4 text-white/70">
                      ...
                      <span>•</span>
                      <span>{viewItems.length} đang hiển thị</span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <input
                      ...
                      className="bg-white/10 border border-white/20 rounded-xl px-4 py-2.5 pl-10 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent w-64"
                    />
                  ...
                  <button
                    onClick={clearShown}
                    className="bg-red-500/20 text-red-400 px-4 py-2.5 rounded-xl hover:bg-red-500/30 hover:text-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={!activeList || viewItems.length === 0}
          >
            Xóa hiển thị
          </button>
                </div>
