      ...
      <div className="relative z-10 space-y-8 p-6">
        ...
        <div className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur-sm">
          <div className="flex flex-wrap items-center gap-4">
            ...
            {/* Search */}
            <div className="flex items-center gap-2 rounded-2xl bg-white/10 px-4 py-2 ring-1 ring-white/20 focus-within:ring-2 focus-within:ring-primary-500/60 sm:w-80">
        ...
        {import.meta.env.DEV && items.length > 0 && (
          <div className="text-xs text-white/40 mt-4 p-2 bg-white/5 rounded">
             Có {items.length} phim yêu thích, hiển thị {view.length} mục
          </div>
        )}
