                    ...
                    <div key={list.id} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/10 hover:ring-white/20 transition-all duration-200">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex-1 bg-blue-500/20 text-blue-400 px-4 py-2 rounded-lg hover:bg-blue-500/30 transition-colors text-sm font-medium"
                        >
                          Xem danh sách
                        </button>
                        <button
                          onClick={() => navigate(`/account/lists`)}
                          className="bg-white/10 text-white/70 px-4 py-2 rounded-lg hover:bg-white/20 transition-colors text-sm"
                        >
                          Chỉnh sửa
                        </button>
                      </div>
