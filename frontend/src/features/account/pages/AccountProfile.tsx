...
export default function AccountProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-3xl">
      ...
      {message && (
        ...
        <div className="w-full">
          ...
          <div className="rounded-3xl bg-white/5 p-8 ring-1 ring-white/10 backdrop-blur-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl bg-white/10 px-4 py-3 text-white border border-white/20 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
                  required
                />
              </div>
            ...
            <div className="flex flex-col gap-3 mt-6">
              <button 
                type="button"
                disabled={isUpdating}
                className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-4 px-6 rounded-2xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg text-lg"
          ...
          {/* Password Form */}
          {showPasswordForm && (
            <div className="mt-8 rounded-3xl bg-white/5 p-8 ring-1 ring-white/10 backdrop-blur-sm">
