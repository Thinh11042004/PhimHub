...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero / welcome */}
      <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-gradient-to-tr from-white/5 to-white/10 p-5 md:flex-row md:items-center md:justify-between">
        <div>
        ...
        <div className="flex gap-2">
          ...
          <ActionButton primary onClick={() => navigate('/admin/upload-movie')}>Tạo nội dung</ActionButton>
        </div>
      </div>
