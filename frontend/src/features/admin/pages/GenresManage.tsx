...
export default function GenresManage() {
  ...
  return (
    <div className="w-full px-3 py-5 text-white md:px-4">
      {/* Header */}
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-56 rounded-2xl border border-white/15 bg-white/10 px-4 py-2 text-sm outline-none placeholder:text-white/60 focus:ring-2 focus:ring-cyan-400/60"
          />
          <button
            className="rounded-xl px-3 py-2 text-sm font-medium ring-1 ring-white/20 hover:bg-white/10"
            onClick={() => setShowAdd(true)}
          >
            Thêm thể loại
          </button>
          <Link to="/admin" className="rounded-xl bg-white/10 px-3 py-2 text-sm hover:bg-white/15">Quay lại Admin</Link>
        </div>
      </div>
