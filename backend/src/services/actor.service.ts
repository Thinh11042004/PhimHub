...
export class ActorService {
  ...
  async getActorsForSelection(excludeIds: number[] = [], search: string = '', limit: number = 50): Promise<Actor[]> {
    return await this.actorRepository.findForSelection(excludeIds, search, limit);
  }
}
