...
export class DirectorService {
  ...
  async getDirectorsForSelection(excludeIds: number[] = [], search: string = '', limit: number = 50): Promise<Director[]> {
    return await this.directorRepository.findForSelection(excludeIds, search, limit);
  }
}
